...
var ui = cfg.ui || {
  ...
  discountInfo:    function(nxt, nd) { return 'Reach <strong>' + fmtK(nxt) + '</strong> for <strong>' + nd + '% off</strong> one-time projects.'; },
  discountUnlocked:'<strong>15% off</strong> unlocked on one-time projects!',
  discReachShort:  function(nxt, nd) { return 'Reach ' + fmtK(nxt) + ' for ' + nd + '% off'; },
  discUnlockedShort:'15% off unlocked!',
  discReachLong:   function(nxt, nd) { return 'Reach ' + fmtK(nxt) + ' for ' + nd + '% off one-time projects'; },
